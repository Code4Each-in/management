...
<div class="container chat-wrapper">
    ...
    <div class="main-section">
        ...
        <form method="POST" id="messagedata" action="{{ route('message.add') }}">
          <input type="hidden" name="_token" value="eWlS2tJP9gtD1M1rhxB3ga3tiQWODH8pNlmgZVwW">              <div class="post-item clearfix mb-3 mt-3">
            ...
            <div class="col-sm-12">
                ...
                <div id="editor" style="height: 300px;" class="ql-container ql-snow"><div class="ql-editor ql-blank" contenteditable="true" data-placeholder="Add your description here...."><p><br></p></div><div class="ql-tooltip ql-hidden"><a class="ql-preview" rel="noopener noreferrer" target="_blank" href="about:blank"></a><input type="text" data-formula="e=mc^2" data-link="https://quilljs.com" data-video="Embed URL"><a class="ql-action"></a><a class="ql-remove"></a></div></div>
          ...
          <input type="hidden" class="form-control" name="id" id="hidden_id" value="1292">
  ...
  <script>
    $(document).ready(function() {
      $('#commentsData').on('submit', function(e) {
          ...
          $('#loader').show(); 
          $.ajax({
              url: 'https://hr.code4each.com/add/comments',
              type: 'POST',
              data: formData,
              contentType: false, 
              processData: false, 
  ...
  <script>
    ...
    <script>
        function loadMessages(projectId) {
            // Clear previous messages from the chat container
            const chatContainer = document.querySelector(".chat-container");
            chatContainer.innerHTML = "";  // This removes the static content
    
            // Fetch messages related to the selected project
            $.ajax({
                url: "{{ url('/get/project/messages') }}/" + projectId,
                type: "GET",
                success: function(data) {
                    displayMessages(data.messages); // Pass the received messages to be displayed
                },
        ...
        function displayMessages(messages) {
            ...
            if (messages.length === 0) {
                ...
                noMessagesMessage.classList.add("text-muted");
                noMessagesMessage.textContent = "No messages available.";
                    ...
                    const userInfo = `
                        ...
                        <div class="user">
                            <div class="avatar" style="background-color: #27ae60;">
                                <img src="https://i.pravatar.cc/42?img=1" alt="Profile" class="rounded-circle" width="35" height="35">
                            </div>
                            <div style="display: inline-block; vertical-align: middle;">
                                <span class="name">${message.user.first_name}</span>
                                <span class="role">Code4Each</span> 
                            </div>
                        </div>`;
    
                    const messageText = `<div class="text">
                        <p>${message.message}</p>
                    </div>`;
