      ...
      <div class="card-body p-3">
        <div class="row g-3">
          ...
          <div class="col-md-6">
            ...
            <textarea name="testing_done" class="form-control form-control-sm" rows="2" placeholder="Describe test scenarios covered" style="font-family: 'Nunito', sans-serif;">{{ old('testing_done') }}</textarea>
          </div>
          <div class="col-12">
