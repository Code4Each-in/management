            ...
            <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                    ...
                    @if(auth()->user()->role_id !== 6)
                        ...
                        <div class="row mb-3">
                            <label for="emergency_name" class="col-md-4 col-lg-3 col-form-label">Emergency Contact</label>
                            <div class="col-md-8 col-lg-9">
                                Name<input name="emergency_name" type="text" class="form-control" id="emergency_name"
                                    value="{{$usersProfile->emergency_name}}" data-role="taginput"
                                    placeholder="Enter emergency contact name">

                                Relation<select name="emergency_relation" class="form-control" id="emergency_relation">
                                    <option value="">Select Relationship</option>
                                    <option value="Husband" {{ $usersProfile->emergency_relation == 'Husband' ? 'selected' : '' }}>Husband</option>
                                    <option value="Wife" {{ $usersProfile->emergency_relation == 'Wife' ? 'selected' : '' }}>Wife</option>
                                    <option value="Father" {{ $usersProfile->emergency_relation == 'Father' ? 'selected' : '' }}>Father</option>
                                    <option value="Mother" {{ $usersProfile->emergency_relation == 'Mother' ? 'selected' : '' }}>Mother</option>
                                    <option value="Brother" {{ $usersProfile->emergency_relation == 'Brother' ? 'selected' : '' }}>Brother</option>
                                    <option value="Sister" {{ $usersProfile->emergency_relation == 'Sister' ? 'selected' : '' }}>Sister</option>
                                </select>

                                Phone No.<input name="emergency_phone" type="number" class="form-control" id="emergency_phone"
                                    value="{{$usersProfile->emergency_phone}}" data-role="taginput"
                                    placeholder="Enter emergency contact number">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="emergency_name_secondary" class="col-md-4 col-lg-3 col-form-label">Emergency Contact 2</label>
                            <div class="col-md-8 col-lg-9">
                                Name<input name="emergency_name_secondary" type="text" class="form-control" id="emergency_name_secondary"
                                    value="{{ old('emergency_name_secondary', $usersProfile->emergency_name_secondary) }}"
                                    placeholder="Enter emergency contact name">

                                Relation<select name="emergency_relation_secondary" class="form-control" id="emergency_relation_secondary">
                                    <option value="">Select Relationship</option>
                                    <option value="Husband" {{ $usersProfile->emergency_relation_secondary == 'Husband' ? 'selected' : '' }}>Husband</option>
                                    <option value="Wife" {{ $usersProfile->emergency_relation_secondary == 'Wife' ? 'selected' : '' }}>Wife</option>
                                    <option value="Father" {{ $usersProfile->emergency_relation_secondary == 'Father' ? 'selected' : '' }}>Father</option>
                                    <option value="Mother" {{ $usersProfile->emergency_relation_secondary == 'Mother' ? 'selected' : '' }}>Mother</option>
                                    <option value="Brother" {{  $usersProfile->emergency_relation_secondary == 'Brother' ? 'selected' : '' }}>Brother</option>
                                    <option value="Sister" {{  $usersProfile->emergency_relation_secondary == 'Sister' ? 'selected' : '' }}>Sister</option>
                                </select>

                                Phone no.<input name="emergency_phone_secondary" type="number" class="form-control" id="emergency_phone_secondary"
                                    value="{{ old('emergency_phone_secondary', $usersProfile->emergency_phone_secondary) }}"
                                    placeholder="Enter emergency contact number">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#emergencyForm').submit(function(event) {
                ...
                $.ajax({
                    url: "{{ request()->url() }}", // Uses the current page URL
                    type: "POST",
                    data: $(this).serialize(),
                    headers: {
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            $('#message').html('<div class="alert alert-danger">Error updating contact.</div>');
                        }
                    },
                    error: function(xhr) {
