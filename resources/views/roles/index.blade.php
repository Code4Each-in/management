			...
			<div class="modal-body">
				...
				<div class="row">
					...
					<div class="form-check col-md-2 mb-4">
						<label class="form-check-label" for="{{'listing_page_'.$val->id}}"> {{$val->module_name}}</label>
		...
		@csrf
			<div class="modal-body">
				...
				<div class="row">
					...
					@forelse($page->module as $val)
					<div class="form-check col-md-2 mb-4">
						<label class="form-check-label" for="{{'role_permissions_'.$val->id}}"> {{$val->module_name}}</label>
